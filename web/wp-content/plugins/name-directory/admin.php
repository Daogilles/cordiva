...
function name_directory_names()
{
    ...
    if(isset($_GET['status']) == 'published')
    {
        $published_status = '1';
        $emphasis_class = 's_published';
    }
    else if(isset($_GET['status']) == 'unpublished')
    {
        $published_status = '0';
    ...
    <table class="wp-list-table widefat" cellpadding="0">
        ...
        <tbody>
            <tr id="add_name">
                ...
                <td width="82%"><input type="text" name="name" value="<?php if(isset($name['name'])){ echo $name['name'];} ?>" size="20" style="width: 100%;"></td>
            </tr>
            <tr id="add_description">
                <td><?php echo __('Description', 'name-directory'); ?></td>
                <td><textarea name="description" rows="5" style="width: 100%;"><?php if(isset($name['description'])){ echo stripslashes($name['description']);} ?></textarea>
            ...
            <tr id="add_submitter">
                ...
                <td><input type="text" name="submitted_by" value="<?php if(isset($name['submitted_by'])){ echo $name['submitted_by'];} ?>" size="20" style="width: 100%;"></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
